    ...
    <section className="home">
      ...
      <div className="grid-container">
        <article className="article1">
          ...
          <p>
            Avant de devenir Univers Aquat oue, Monsieur & Madame DENNEMONT ont
        ...
        <article className="article2">
          ...
          <ul className="conteneurA2">
            ...
            {/* <li className="ssArticle1">
              <h4>Aquariophilie</h4>
              {/* <p>blablabla sur les demmaines de l'aquariophilie </p> 
              <ul className="aquario">
                <li>
                  <h4>Aquariophilie</h5>
                  <p>
                    L'aquariophilie est une passion ancienne et captivante qui
                    consiste à élever des poissons, des plantes et d'autres
                    organismes aquatiques dans un environnement contrôlé. Chez
                    Univers Aquatique, nous proposons une vaste gamme de
                    produits et de conseils pour tous les passionnés, qu'ils
                    soient novices ou expérimentés.
                  </p>
                  <img src="../../src/assets/images/IMG_5785.JPG" />
                </li>
                <li>
                  <h5>Aquariophilie Marine</h5>
                  <p>
                    L'aquariophilie marine est une branche fascinante de
                    l'aquariophilie qui se concentre sur l'élevage et le
                    maintien d'organismes marins tels que les poissons, les
                    coraux et les invertébrés. Découvrez notre sélection
                    d'équipements spécialisés et de conseils avisés pour créer
                    et entretenir un aquarium marin florissant.
                  </p>
                  <img src="../../src/assets/images/videoAnemone.gif" />
                </li>
                <li>
                  <h5>Aquascaping</h5>
                  <p>
                    L'aquascaping est un art qui consiste à créer des paysages
                    aquatiques esthétiques et harmonieux dans les aquariums.
                    Avec notre expertise et notre sélection minutieuse de
                    plantes, de roches et de matériaux naturels, vous pouvez
                    transformer votre aquarium en une véritable œuvre d'art
                    vivante.
                  </p>
                  <img src="../../src/assets/images/aquascape1.jpg" />
                </li>
              </ul>
            </li> */}
