...
export function addOneCategor(datas) {
  console.log("Data received for adding category:", datas);
  return axios
    .post(`${config.api_url}/category/save`, datas, {
      headers: { "x-access-token": token },
    })
    .then((res) => {
      console.log("Nouvelle catégorie ajoutée :", datas.name);
      return res.data;
    })
    .catch((err) => {
      return err;
...
// export function updateOneCategor(datas, id) {
//   return axios
//     .put(`${config.api_url}/category/update/${id}`, datas, {
//       headers: { "x-access-token": token },
//     })
//     .then((res) => {
//       return res.data;
